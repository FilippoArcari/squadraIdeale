...
export const PlayerToken = ({
    ...
    return (
        <div
            ...
            {...listeners}
            {...attributes}
            className={`flex flex-col items-center group relative z-10 transition-transform hover:scale-110 cursor-grab active:cursor-grabbing touch-none ${isDragging ? 'opacity-50 scale-105' : ''}`}
        >
